...
namespace Ecwhim\CanonicalUrlGraphQl\Model\Resolver\Product;
...
class CanonicalUrl implements \Magento\Framework\GraphQl\Query\ResolverInterface
{
    ...
    public function resolve(
        ...
        $canonicalUrlResolver = $this->canonicalUrlResolverFactory->create('catalog_product_view');

        if ($canonicalUrlResolver === null) {
            return null;
        }

        return $canonicalUrlResolver->getCanonicalUrl($product, $storeId);
    }
}
